// ======================================================================
// \title  hedgegpsTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef HEDGEGPS_HEDGEGPSTOPOLOGY_HPP
#define HEDGEGPS_HEDGEGPSTOPOLOGY_HPP
// Included for access to hedgegps::TopologyState and hedgegps::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <hedgegps/Top/hedgegpsTopologyDefs.hpp>

// Remove unnecessary hedgegps:: qualifications
 ...
 * hedgegps::TopologyState see: hedgegpsTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type hedgegps::TopologyState see: hedgegpsTopologyDefs.hpp.
 *
