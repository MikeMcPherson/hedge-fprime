...
#include <hedgegps/Top/hedgegpsTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    hedgegps::setupTopology(inputs);
    hedgegps::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    hedgegps::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
