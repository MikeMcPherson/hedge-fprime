...
#include <gps/Top/gpsTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    gps::setupTopology(inputs);
    gps::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    gps::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
