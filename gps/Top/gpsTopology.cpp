// ======================================================================
// \title  gpsTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <gps/Top/gpsTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <gps/Top/gpsPacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::gps_blockDrv::WARN, PingEntries::gps_blockDrv::FATAL, "blockDrv"},
    {PingEntries::gps_tlmSend::WARN, PingEntries::gps_tlmSend::FATAL, "chanTlm"},
    {PingEntries::gps_cmdDisp::WARN, PingEntries::gps_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::gps_cmdSeq::WARN, PingEntries::gps_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::gps_eventLogger::WARN, PingEntries::gps_eventLogger::FATAL, "eventLogger"},
    {PingEntries::gps_fileDownlink::WARN, PingEntries::gps_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::gps_fileManager::WARN, PingEntries::gps_fileManager::FATAL, "fileManager"},
    {PingEntries::gps_fileUplink::WARN, PingEntries::gps_fileUplink::FATAL, "fileUplink"},
    {PingEntries::gps_prmDb::WARN, PingEntries::gps_prmDb::FATAL, "prmDb"},
    {PingEntries::gps_rateGroup1::WARN, PingEntries::gps_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::gps_rateGroup2::WARN, PingEntries::gps_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::gps_rateGroup3::WARN, PingEntries::gps_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology() {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(gpsPacketsPkts, gpsPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name gps
namespace gps {
