// ======================================================================
// \title  gpsTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef GPS_GPSTOPOLOGY_HPP
#define GPS_GPSTOPOLOGY_HPP
// Included for access to gps::TopologyState and gps::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <gps/Top/gpsTopologyDefs.hpp>

// Remove unnecessary gps:: qualifications
using namespace gps;
namespace gps {
/**
 ...
 * gps::TopologyState see: gpsTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type gps::TopologyState see: gpsTopologyDefs.hpp.
 *
